...
SPEC-012 +9, SPEC-011 +5; +4 more from T-157 — SPEC-010 +3, SPEC-008 +1). SPEC-010 and SPEC-012 drop to `?` coverage under the rule below; two of the
