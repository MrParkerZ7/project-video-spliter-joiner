...
| [SPEC-010](SPEC-010-split-screen.md) | split-screen | app | 60 | ? | ? |
...
SPEC-011 I145-I147, the two-row footer; +5 from T-161 — SPEC-007 I95-I99, the scrollable profile bar; +9 from T-162 — SPEC-010 I52-I60, delete-original on Split). SPEC-010 and SPEC-012 drop to `?` coverage under the rule below; two of the
